...
?>
<div class="container">
  <form name="form" id="form" method="post" action="test1.php"  Enctype="multipart/form-data" >
  <?php if ($fid != null) { ?>
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800"><input name="name" value="<?php echo $fname ?>"></div>
              </div>
              <div class="col-auto">
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="row no-gutters align-items-center">
                  <div class="col-auto">
                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><input type="date"></div>
                  </div>
                </div>
              </div>
              <div class="col-auto">
                ...
                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                  ...
                  <tbody>
                    <tr role="row" class="odd">
                      ...
                      <td> <input name="f1"  class="form-control" required="true" value="<?php echo "$f1"; ?>" type="text">
                      </td>
                    ...
                    <tr role="row" class="even">
                      ...
                      <td> <input name="f2"  class="form-control" required="true" value="<?php echo "$f2"; ?>" type="text">
                      </td>
                    ...
                    <tr role="row" class="odd">
                      ...
                      <td> <input name="f3"  class="form-control" required="true" value="<?php echo "$f3"; ?>" type="text">
                      </td>
                    ...
                    <tr role="row" class="even">
                      ...
                      <td> <input name="f4"  class="form-control" required="true" value="<?php echo "$f4"; ?>" type="text">
                      </td>
                    ...
                    <tr role="row" class="odd">
                      ...
                      <td><?php echo "$end"; ?></td>
                      <td> <input name="f5"  class="form-control" required="true" value="<?php echo "$f5"; ?>" type="text">
                      </td>
